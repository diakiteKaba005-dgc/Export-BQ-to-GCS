...
with DAG(
    'dag_test_export_delta',
    default_args=default_args,
    description='DAG de test pour l export Delta',
    ...
    payload = {
        ...
        "params": {
            ...
            "destination": {
                ...
                "file_name_prefix": "tests/delta/export_",
                "type_extraction": "CSV"
            }
        }
    }
