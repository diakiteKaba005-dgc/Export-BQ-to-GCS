...
with DAG(
    'dag_test_config_and_run',
    default_args=default_args,
    description='DAG de test pour Config_and_Run -> Run',
    ...
    payload = {
        ...
        "params": {
            ...
            "destination": {
                ...
                "file_name_prefix": "tests/config_and_run/export_",
                "type_extraction": "CSV"
            }
        }
    }
    ...
    trigger = HttpOperator(
        task_id='trigger_test_config_and_run',
